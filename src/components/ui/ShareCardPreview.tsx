...
export function ShareCardPreview({
  ...
  return (
    <div className="flex flex-col gap-3 card-entrance">
      <div
        className="w-full relative rounded-2xl overflow-hidden neu-extruded bg-[#0f172a] text-white flex flex-col justify-center items-center p-8"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
          <h2 className="text-primary font-display font-bold text-3xl md:text-5xl tracking-tight mb-8">
            SentimentPerps
          </h2>
          
          <div className="bg-white/5 border border-white/10 rounded-[32px] px-8 py-6 mb-6 backdrop-blur-sm">
            <p className="text-gray-400 text-sm md:text-base font-medium text-center mb-2 uppercase tracking-widest">
              Referral Code
            </p>
          ...
          <div className="flex items-center gap-4 text-gray-300 font-medium text-base md:text-xl">
